  ...
  metrics: [
    {
      id: "portfolio-growth",
      value: "847%",
      title: "Proven Impact and Results",
      subtitle: "Portfolio growth: Current Fortune 500 client engagement demonstrating sustained value creation over 5-year strategic partnership",
      icon: "TrendingUp",
      color: "primary",
      animationDuration: 2500
    },
    {
      id: "valuation-multiplier",
      value: "4.1x",
      title: "Valuation Excellence",
      subtitle: "$410M → $1.7B successful acquisition: Documented enterprise transformation driving measurable shareholder value",
      icon: "Building2",
      color: "secondary",
    ...
    },
    {
      id: "total-impact",
      value: "$5B+",
      title: "Cumulative Value Creation",
      subtitle: "Total documented project value delivered: Verifiable through public market data and qualified reference discussions",
      icon: "DollarSign",
      color: "primary",
